...
const TimeAnalysis = ({ activityLogs, selectedUser, dateRange = 'all' }) => {
    ...
    const renderClock = () => {
        ...
        return (_jsx("div", { className: "relative w-80 h-80 mx-auto", children: _jsxs("div", { className: "absolute inset-0 rounded-full border-4 border-gray-200 dark:border-gray-700", children: [indicators.map((indicator) => {
                        ...
                        return (_jsx("div", { className: "absolute text-xxs font-medium text-gray-600 dark:text-gray-300 transform -translate-x-1/2 -translate-y-1/2", style: {
                                left: `${x}%`,
                                top: `${y}%`,
                                backgroundColor: 'var(--tw-bg-opacity)',
                                padding: '2px 4px',
                                borderRadius: '2px',
                            }, children: _jsx("span", { className: "bg-white dark:bg-gray-800 px-1 py-0.5 rounded", children: `${hour === 0 ? '12' : hour > 12 ? hour - 12 : hour}${hour < 12 ? 'AM' : 'PM'}` }) }, hour));
                    })] }) }));
    };
    const renderChart = () => {
        if (viewType === 'scatter') {
            return (_jsx(ResponsiveContainer, { width: "100%", height: "100%", children: _jsxs(ScatterChart, { margin: { top: 20, right: 10, bottom: 20, left: 10 }, children: [_jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "#f1f5f9" }), _jsx(XAxis, { type: "number", dataKey: "x", domain: [0, 24], ticks: [0, 6, 12, 18, 24], tick: { fill: '#64748b', fontSize: 10 }, tickFormatter: (value) => {
                                ...
                                return (_jsxs("div", { className: "bg-white dark:bg-gray-800 p-4 shadow-lg rounded-lg border border-gray-100 dark:border-gray-700", children: [_jsx("p", { className: "font-semibold text-gray-800 dark:text-gray-200 mb-2", children: new Date(data.timestamp).toLocaleTimeString() }), _jsxs("div", { className: "space-y-1", children: [_jsxs("div", { className: "flex justify-between gap-4", children: [_jsx("span", { className: "text-violet-600 dark:text-violet-400", children: "Accuracy:" }), _jsxs("span", { className: "font-medium text-gray-700 dark:text-gray-300", children: [data.y, "%"] })] }), _jsxs("div", { className: "flex justify-between gap-4", children: [_jsx("span", { className: "text-violet-400 dark:text-violet-300", children: "Correct:" }), _jsx("span", { className: "font-medium text-gray-700 dark:text-gray-300", children: data.correct })] }), _jsxs("div", { className: "flex justify-between gap-4", children: [_jsx("span", { className: "text-gray-500 dark:text-gray-400", children: "Total:" }), _jsx("span", { className: "font-medium text-gray-700 dark:text-gray-300", children: data.completed })] })] })] }));
        ...
        return (_jsx(ResponsiveContainer, { width: "100%", height: "100%", children: _jsxs(ComposedChart, { data: hourlyData, margin: { top: 20, right: 10, bottom: 20, left: 10 }, children: [_jsx(CartesianGrid, { strokeDasharray: "3 3", stroke: "#f1f5f9" }), _jsx(XAxis, { dataKey: "hour", tick: { fill: '#64748b', fontSize: 10 }, tickMargin: 8 }), _jsx(YAxis, { yAxisId: "left", domain: [0, 100], tick: { fill: '#64748b', fontSize: 10 }, tickMargin: 8 }), _jsx(YAxis, { yAxisId: "right", orientation: "right", tick: { fill: '#64748b', fontSize: 10 }, tickMargin: 8 }), _jsx(ReferenceLine, { yAxisId: "left", y: averageAccuracy, stroke: "#dc2626", strokeDasharray: "3 3", label: _jsx(Label, { value: `Avg ${averageAccuracy}%`, position: "right", fill: "#dc2626", fontSize: 10 }) }), _jsx(Tooltip, { content: ({ payload }) => {
                            if (!payload?.length)
                                return null;
                            const data = payload[0].payload;
                            return (_jsxs("div", { className: "bg-white dark:bg-gray-800 p-4 shadow-lg rounded-lg border border-gray-100 dark:border-gray-700", children: [_jsxs("p", { className: "font-semibold text-gray-800 dark:text-gray-200 mb-2", children: [data.hour, " hrs"] }), _jsxs("div", { className: "space-y-1", children: [_jsxs("div", { className: "flex justify-between gap-4", children: [_jsx("span", { className: "text-violet-600 dark:text-violet-400", children: "Accuracy:" }), _jsxs("span", { className: "font-medium text-gray-700 dark:text-gray-300", children: [data.accuracy, "%"] })] }), _jsxs("div", { className: "flex justify-between gap-4", children: [_jsx("span", { className: "text-violet-400 dark:text-violet-300", children: "Questions:" }), _jsx("span", { className: "font-medium text-gray-700 dark:text-gray-300", children: data.totalQuestions })] }), _jsxs("div", { className: "flex justify-between gap-4", children: [_jsx("span", { className: "text-gray-500 dark:text-gray-400", children: "Sessions:" }), _jsx("span", { className: "font-medium text-gray-700 dark:text-gray-300", children: data.attempts })] })] })] }));
    ...
    return (_jsxs("div", { className: "w-full", children: [_jsxs("div", { className: "flex flex-wrap gap-4 justify-between items-center mb-4", children: [_jsxs("div", { children: [_jsx("h3", { className: "text-lg font-semibold text-gray-900 dark:text-gray-100", children: "Performance by 3-Hour Intervals" }), _jsx("p", { className: "text-sm text-gray-500 dark:text-gray-400", children: "Accuracy trends and activity patterns" })] }), _jsx("div", { className: "flex gap-4 items-center", children: _jsxs("div", { className: "flex gap-2", children: [_jsx("button", { onClick: () => setViewType('chart'), className: `px-3 py-1 rounded-md text-sm ${viewType === 'chart'
                                        ? 'bg-violet-600 text-white dark:bg-violet-500'
                                        : 'bg-gray-100 text-gray-700 hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600'}`, children: "Chart" }), _jsx("button", { onClick: () => setViewType('scatter'), className: `px-3 py-1 rounded-md text-sm ${viewType === 'scatter'
                                        ? 'bg-violet-600 text-white dark:bg-violet-500'
                                        : 'bg-gray-100 text-gray-700 hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600'}`, children: "Scatter" }), _jsx("button", { onClick: () => setViewType('clock'), className: `px-3 py-1 rounded-md text-sm ${viewType === 'clock'
                                        ? 'bg-violet-600 text-white dark:bg-violet-500'
                                        : 'bg-gray-100 text-gray-700 hover:bg-gray-200 dark:bg-gray-700 dark:text-gray-300 dark:hover:bg-gray-600'}`, children: "Clock" })] }) })] }), _jsx("div", { className: "relative h-80 sm:h-96 mb-4", children: viewType === 'clock' ? renderClock() : viewType === 'scatter' ? renderChart() : renderChart() }), (peakPeriod.accuracy > 0 || lowPeriod.accuracy < 100) && (_jsxs("div", { className: "flex gap-4 justify-end", children: [peakPeriod.accuracy > 0 && (_jsxs("div", { className: "bg-green-50 dark:bg-green-900/30 px-3 py-2 rounded-lg text-sm", children: [_jsx("span", { className: "text-green-700 dark:text-green-400 font-medium", children: "Peak: " }), _jsxs("span", { className: "text-green-600 dark:text-green-300", children: [peakPeriod.hour, " (", peakPeriod.accuracy, "%)"] })] })), lowPeriod.accuracy < 100 && (_jsxs("div", { className: "bg-red-50 dark:bg-red-900/30 px-3 py-2 rounded-lg text-sm", children: [_jsx("span", { className: "text-red-700 dark:text-red-400 font-medium", children: "Low: " }), _jsxs("span", { className: "text-red-600 dark:text-red-300", children: [lowPeriod.hour, " (", lowPeriod.accuracy, "%)"] })] }))] }))] }));
};
