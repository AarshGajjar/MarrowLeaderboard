...
const UserStatsRadarChart = ({ user1, user2, isOpen, onOpenChange }) => {
    ...
    return (_jsx(Dialog, { open: isOpen, onOpenChange: onOpenChange, children: _jsxs(DialogContent, { className: "w-[95vw] max-w-md p-0 max-h-[90vh] overflow-y-auto", children: [_jsx(DialogHeader, { className: "p-4 pb-0", children: _jsxs(DialogTitle, { className: "text-xl font-semibold text-purple-600 text-center", children: [user1.name, " VS ", user2.name] }) }), _jsxs("div", { className: "flex flex-col space-y-4 p-4", children: [_jsx("div", { className: "h-[300px] w-full relative", children: _jsx(ResponsiveContainer, { width: "100%", height: "100%", children: _jsxs(RadarChart, { data: radarData, margin: { top: -10, right: -20, bottom: -20, left: -20 }, children: [_jsx(PolarGrid, { stroke: "hsl(var(--muted-foreground))", strokeWidth: 0.5, strokeDasharray: "3 3" }), _jsx(PolarAngleAxis, { dataKey: "subject", tick: {
                                                fill: 'hsl(var(--foreground))',
                                                fontSize: 11,
                                                fontWeight: 500,
                                                textAnchor: 'middle',
                                            }, tickLine: false }), _jsx(Radar, { name: user1.name, dataKey: user1.name, stroke: "#8b5cf6", fill: "#8b5cf6", fillOpacity: 0.2, strokeWidth: 2 }), _jsx(Radar, { name: user2.name, dataKey: user2.name, stroke: "#3b82f6", fill: "#3b82f6", fillOpacity: 0.2, strokeWidth: 2 }), _jsx(Tooltip, { cursor: false, contentStyle: {
                                            ...
                                            } })] }) }) }), _jsxs("div", { className: "grid grid-cols-2 gap-4", children: [_jsx(Card, { className: "bg-background", children: _jsxs(CardContent, { className: "p-4", children: [_jsx("h3", { className: "font-medium text-foreground/80 mb-2", children: user1.name }), _jsxs("div", { className: "space-y-1 text-xs text-foreground/70", children: [_jsxs("p", { children: ["Total: ", user1.total] }), _jsxs("p", { children: ["Correct: ", user1.correct] }), _jsxs("p", { children: ["Accuracy: ", user1.accuracy.toFixed(1), "%"] }), _jsxs("p", { children: ["Daily Avg: ", user1.dailyAverage.toFixed(1)] }), _jsxs("p", { children: ["Consistency: ", user1.consistency.toFixed(1), "%"] }), _jsxs("p", { children: ["Streak: ", user1.streak] })] })] }) }), _jsx(Card, { className: "bg-background", children: _jsxs(CardContent, { className: "p-4", children: [_jsx("h3", { className: "font-medium text-foreground/80 mb-2", children: user2.name }), _jsxs("div", { className: "space-y-1 text-xs text-foreground/70", children: [_jsxs("p", { children: ["Total: ", user2.total] }), _jsxs("p", { children: ["Correct: ", user2.correct] }), _jsxs("p", { children: ["Accuracy: ", user2.accuracy.toFixed(1), "%"] }), _jsxs("p", { children: ["Daily Avg: ", user2.dailyAverage.toFixed(1)] }), _jsxs("p", { children: ["Consistency: ", user2.consistency.toFixed(1), "%"] }), _jsxs("p", { children: ["Streak: ", user2.streak] })] })] }) })] })] })] }) }));
};
