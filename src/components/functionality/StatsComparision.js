...
const StatsComparison = ({ stats, dailyData, activityLogs, onUpdateProgress }) => {
    ...
    const ComparisonBar = ({ label, value1, value2, unit = '' }) => {
        ...
        return (_jsxs("div", { className: "w-full p-4 rounded-lg", children: [_jsx("div", { className: "text-sm font-medium text-center mb-3 text-slate-700", children: label }), _jsxs("div", { className: "flex items-center gap-4", children: [_jsx("div", { className: "w-16 text-right", children: _jsxs("span", { className: "font-semibold text-sm text-[#7242eb] px-3 py-1 rounded-lg bg-purple-50 border border-purple-100 shadow-sm", children: [value1, unit] }) }), _jsxs("div", { className: "flex-1 h-8 rounded-lg relative", children: [_jsxs("div", { className: "absolute inset-0 flex", children: [_jsx("div", { className: "w-1/2 flex justify-end", children: _jsx("div", { className: `absolute top-0 bottom-0 right-1/2 ${value1 >= value2 ? colors.better : colors.worse} rounded-l-lg transition-all duration-300`, style: {
                                                    ...
                                                    width: `${width2 / 2}%`,
                                                    left: '50%'
                                                } }) })] }), _jsx("div", { className: "absolute inset-0 flex items-center justify-center", children: _jsxs("span", { className: "text-xs font-bold bg-white/90 px-2 py-0.5 rounded-full shadow-sm", children: [Math.abs(value1 - value2).toFixed(unit === '%' ? 1 : 0), unit] }) })] }), _jsx("div", { className: "w-16 text-left", children: _jsxs("span", { className: "font-semibold text-sm text-[#7242eb] px-3 py-1 rounded-lg bg-purple-50 border border-purple-100 shadow-sm", children: [value2, unit] }) })] })] }));
    };
    return (_jsxs(_Fragment, { children: [_jsx(Card, { className: "w-full max-w-3xl mx-auto bg-gradient-to-br from-slate-50 to-slate-100 shadow-lg", children: _jsxs(CardContent, { className: "p-6", children: [_jsxs("div", { className: "grid grid-cols-3 gap-4 mb-8", children: [_jsx("div", { className: "text-center", children: _jsx("h3", { className: "text-lg font-semibold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent p-2 rounded-xl backdrop-blur-sm bg-white/30 shadow-sm border border-purple-100", children: stats.user1.name }) }), _jsxs("div", { className: "text-center", children: [_jsxs("div", { className: "relative", children: [_jsx("div", { className: "absolute inset-0 bg-slate-100/50 rounded-full transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2 w-12 h-12" }), _jsx("button", { onClick: () => setIsRadarChartOpen(true), className: "text-lg font-semibold text-purple-600/70 relative z-10 p-2 hover:text-blue-600 transition-colors", children: "VS" })] }), _jsx("div", { className: "flex justify-center mt-2", children: _jsx("div", { className: "relative", children: _jsx(UserStatsRadarChart, { user1: {
                                                    ...
                                                    }, isOpen: isRadarChartOpen, onOpenChange: setIsRadarChartOpen }) }) })] }), _jsx("div", { className: "text-center", children: _jsx("h3", { className: "text-lg font-semibold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent p-2 rounded-xl backdrop-blur-sm bg-white/30 shadow-sm border border-purple-100", children: stats.user2.name }) })] }), _jsxs("div", { className: "space-y-4", children: [_jsx(ComparisonBar, { label: "Total Completed", value1: stats.user1.completed, value2: stats.user2.completed }), _jsx(ComparisonBar, { label: "Correct Answers", value1: stats.user1.correct, value2: stats.user2.correct }), _jsx(ComparisonBar, { label: "Accuracy", value1: user1Metrics.accuracy, value2: user2Metrics.accuracy, unit: "%" })] }), _jsxs("div", { className: "grid grid-cols-3 gap-4 mt-8", children: [_jsxs("div", { className: "flex flex-col sm:flex-row justify-center gap-2 px-2", children: [_jsxs(Button, { variant: "outline", size: "sm", onClick: () => { setActiveUser('user1'); setIsDialogOpen(true); }, className: "w-full sm:w-24 hover:bg-purple-50 border-purple-600/20", children: [_jsx(Plus, { className: "w-4 h-4 mr-1 text-purple-600" }), _jsx("span", { className: "text-purple-600", children: "Add" })] }), _jsxs(Button, { variant: "outline", size: "sm", onClick: () => { setSelectedProgressUser('user1'); setShowProgress(true); }, className: "w-full sm:w-24 hover:bg-blue-50 border-blue-600/20", children: [_jsx(ChartLine, { className: "w-4 h-4 mr-1 text-blue-600" }), _jsx("span", { className: "text-blue-600", children: "Stats" })] })] }), _jsx("div", {}), " ", _jsxs("div", { className: "flex flex-col sm:flex-row justify-center gap-2 px-2", children: [_jsxs(Button, { variant: "outline", size: "sm", onClick: () => { setActiveUser('user2'); setIsDialogOpen(true); }, className: "w-full sm:w-24 hover:bg-purple-50 border-purple-600/20", children: [_jsx(Plus, { className: "w-4 h-4 mr-1 text-purple-600" }), _jsx("span", { className: "text-purple-600", children: "Add" })] }), _jsxs(Button, { variant: "outline", size: "sm", onClick: () => { setSelectedProgressUser('user2'); setShowProgress(true); }, className: "w-full sm:w-24 hover:bg-blue-50 border-blue-600/20", children: [_jsx(ChartLine, { className: "w-4 h-4 mr-1 text-blue-600" }), _jsx("span", { className: "text-blue-600", children: "Stats" })] })] })] }), _jsx("div", { className: "mt-8 flex justify-center", children: _jsxs("div", { className: "flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-yellow-50 to-yellow-100 rounded-lg shadow-sm", children: [_jsx(Crown, { className: "w-5 h-5 text-yellow-500" }), _jsxs("span", { className: "font-medium text-slate-700", children: [stats[leader].name, " leads by ", pointsDiff, " points"] })] }) }), _jsx(Dialog, { open: isDialogOpen, onOpenChange: (open) => {
