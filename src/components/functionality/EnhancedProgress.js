...
const DualUserProgress = ({ user1, user2, target }) => {
    ...
    return (_jsx(Card, { className: "w-full", children: _jsxs(CardContent, { className: "pt-2 pb-4 px-6 relative", children: [_jsx("p", { className: "text-m text-center mb-2 pb-5 text-slate-600 font-semibold bg-gradient-to-r from-purple-100/50 to-blue-100/50 py-2 px-4 rounded-lg shadow-sm", children: getMotivationalMessage() }), _jsxs("div", { className: "relative mt-16 mx-[6%]", children: [_jsx("div", { className: "h-3 w-full rounded-full bg-[#faf5ff] overflow-hidden shadow-inner", children: [user1Stats, user2Stats].map((stats, index) => {
